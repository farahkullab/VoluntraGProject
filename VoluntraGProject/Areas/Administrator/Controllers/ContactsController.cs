...
namespace VoluntraGProject.Areas.Administrator.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Email,Message")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,Email,Message")] Contact contact)
        {
